...
export interface ResearchMemo { id: string; content: string; companyId?: string; companyName?: string; noteId?: string; noteTitle?: string; pinned: boolean; createdAt: string; }
