...
export interface DisclosureSearchResult { company: Pick<Company, "corpCode" | "corpName" | "stockCode">; filing?: SelectedFiling; status: DisclosureStatus; sections: DisclosureSection[]; archiveEntries?: DisclosureArchiveEntry[]; errorMessage?: string; processingStage?: DisclosureProcessingStage; }
export interface DisclosureSection { id: string; title: string; plainText: string; htmlContent?: string; matchedKeywords: string[]; sourceFile?: string; table?: { headers: string[]; rows: string[][] }; }
